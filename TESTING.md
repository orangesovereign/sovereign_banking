...
- ~~**Teller coordinates**~~ — resolved. All seven branches in
  `config/locations.lua` are now placed from clerk marks surveyed in game. Every
  one of the original estimates proved unusable when walked (53m, 7m and 4.7m
