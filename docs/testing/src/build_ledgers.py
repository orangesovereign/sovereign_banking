...
B1 = [
 ...
 {"art": "IV", "title": "At the Counter", "tag": "branches &middot; peds &middot; NUI", "why":
  ...
  "items": [
   {"id": "T1", "who": "a", "t": "Open the map.", "x": "<b>Expect:</b> a bank blip at Valentine, Rhodes, Saint Denis, Blackwater and Tumbleweed."},
   ...
   {"id": "T2b", "who": "a", "t": "Run <code>banking_peds</code> in F8 while standing at the counter.", "x": "<b>Expect:</b> the branch reports <code>ped=yes</code> and <b>off mark under 0.5m</b>. Valentine and Tumbleweed are surveyed and should be near zero; the other three still carry approximations."},
   {"id": "T3", "who": "a", "gate": True, "t": "Stand at the counter and hold <b>[G]</b>.", "x": "<b>Expect:</b> the prompt appears, and holding it opens the bank. <b>If no prompt appears</b>, compare your coords to <code>teller</code> in <code>config/locations.lua</code> &mdash; only Valentine's is surveyed; Tumbleweed's is derived and the rest are approximate."},
